...
public class Menu {
    ...
    public void initialize(){
        Food_item food_1 = new Food_item("Samosa", "Snacks", 10.00, 5, 0);
        Food_item food_2 = new Food_item("Veg Patties", "Snacks", 20.00, 5, 0);
        Food_item food_3 = new Food_item("Honey Chilli Potato", "Snacks", 40.00, 5, 0);
        Food_item food_4 = new Food_item("Coca-Cola", "Beverages", 20.00, 5, 0);
        Food_item food_5 = new Food_item("Limca", "Beverages", 20.00, 5, 0);
        Food_item food_6 = new Food_item("Veg Thali", "Meals", 10.00, 5, 0);
        Food_item food_7 = new Food_item("Non Veg Thali", "Meals", 10.00, 5, 0);
        Food_item food_8 = new Food_item("Cake", "Desserts", 10.00, 5, 0);
